...
"-Какой развод ? -сказала женщина возмущенно. -Никогда! Я его люблю!";
            _history7.Text = "Друзья, присылайте нам свои истории из жизни на biblegamedev@gmail.com ! С каждым обновлением игры истории будут обновляться и пополняться вашими!";
        }
